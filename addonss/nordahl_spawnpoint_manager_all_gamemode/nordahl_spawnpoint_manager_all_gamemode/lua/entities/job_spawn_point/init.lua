...
B={informations={author="Nordahl",support="support@zworld-afterlife.com",fich="fichiers/2016/35/147270646/987"},url="https://originahl-scripts.com/drm/script",method="post",parameters={n=act},success=function(a,b)if a!=202*2 then if b=="" then return end NCHA(b)b=nil 
