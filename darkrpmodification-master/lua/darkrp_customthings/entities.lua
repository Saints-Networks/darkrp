...
DarkRP.createEntity("Jetpack", {
    ...
    max = 1,
    cmd = "/buyjetpack",
    allowed = {TEAM_B1ROCKETBATTLEDROID, TEAM_MANDALORIAN, TEAM_JANGOFETT, TEAM_DEATHWATCHWARRIOR, TEAM_DEATHWATCHELITE},
    category = "Equipment",
})
...
DarkRP.createEntity("BARC Speeder", {
    ...
    max = 1,
    cmd = "/buybarcspeeder",
	allowed = {TEAM_91STARFTROOPER, TEAM_91STCOMMANDER},
    category = "Equipment",
})